...
| **NT-transfer** (Dalla-Torre 2024, frozen seq FM; `scripts/models/46`) | *[진행 중]* | — |
...
> **함의(Paper 2)**: FM/embedding을 살리려면 (a) **p≫n-aware 설계**(Diet-Net식, 이미 73.6%) 또는 (b) **외부 대규모 transfer**(NT, 진행 중)가 길이고, *naive end-to-end 임베딩 학습은 막다른 길*. (NT 결과 후 갱신.)
